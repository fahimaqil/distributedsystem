...
class replica_manager(object):
    ...
    def gossip(self):
        ...
        rm2=Pyro4.Proxy("PYRONAME:rm2")
        rm1.receiveGossip(self.replicaTS,self.log)
        rm2.receiveGossip(self.replicaTS,self.log)
        print("sending")
